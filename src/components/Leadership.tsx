    ...
    <section id="leadership" className="py-24 bg-[#07111F] relative overflow-hidden border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          ...
          <div className="flex items-center space-x-2 bg-white/5 p-1 rounded-full border border-white/10 mt-4 md:mt-0">
            <button
            ...
            >
              All Board Members ({TEAM_MEMBERS.length})
            </button>
          </div>
        </div>
        ...
        <motion.div
          ...
          className="mb-12 glass-card rounded-3xl p-8 sm:p-10 border border-[#D7B65A]/40 shadow-2xl relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-80 h-80 bg-[#D7B65A]/10 rounded-full blur-3xl pointer-events-none -z-10" />

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-4 flex flex-col items-center justify-center p-6 bg-[#0B1728]/80 rounded-2xl border border-[#D7B65A]/20">
              <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-full bg-gradient-to-tr from-[#D7B65A] to-[#06B6D4] p-1 flex items-center justify-center shadow-xl mb-4">
                <div className="w-full h-full rounded-full bg-[#07111F] flex items-center justify-center text-3xl font-heading font-extrabold text-[#E8D89A]">
                  HB
                </div>
              </div>

              <h3 className="font-heading font-extrabold text-2xl text-white text-center">
                Rtr. Hariharan B
              </h3>
        ...
        {selectedLetter && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.95 }}
              className="relative max-w-2xl w-full glass-panel rounded-3xl overflow-hidden border border-white/20 shadow-2xl z-10 p-4 max-h-[90vh] flex flex-col"
            >
              <div className="flex items-center justify-between pb-3 border-b border-white/10 px-2">
                <div>
                  ...
                  <div className="text-xs text-[#D7B65A]">{selectedLetter.position} • Rotary Year 2026–27</div>
                </div>
                <button
                  onClick={() => setSelectedLetter(null)}
              ...
              <div className="overflow-y-auto mt-3 p-2 bg-[#07111F] rounded-xl flex items-center justify-center">
